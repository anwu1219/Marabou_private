...
try:
    ...
    from maraboupy.MarabouNetworkONNXConcat import *
except ImportError:
...
def read_onnx_concat(filename, inputNames=None, outputName=None):
    """Constructs a MarabouNetworkONNX object from an ONNX file
    ...
    Returns:
        :class:`~maraboupy.MarabouNetworkONNX.MarabouNetworkONNX`
    """
    return MarabouNetworkONNXConcat(filename, inputNames, outputName)
...
def createOptions(numWorkers=1, initialTimeout=5, initialDivides=0, onlineDivides=2,
                  ...
                  tighteningStrategy="deeppoly", milpTighteningStrategy="",
                  milpTimeout=1 ):
    ...
    Args:
        ...
        milpTighteningStrategy (string, optional): The milp-based preprocessing strategy (lp/milp/none). default: none )
        milpTimeout (int, optional): The per-PLConstraint timeout used for milp-based preprocessing.
    Returns:
    ...
    options._milpTighteningStrategy = milpTighteningStrategy
    options._milpTimeout = milpTimeout
    return options
